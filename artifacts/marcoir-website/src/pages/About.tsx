...
export default function About() {
  const values = [
    ...
    },
    {
      ...
      desc: "We believe the most powerful outcomes emerge at the intersection of disciplines. A video campaign is stronger when it drives into an AI-powered funnel. A SaaS product is faster to market when automation handles your ops.",
    },
    {
  ...
  return (
    <div className="flex flex-col gap-32">
      ...
      >
        ...
        <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-serif font-bold text-[#321A12] mb-8 leading-snug max-w-3xl">
          To bridge the gap between compelling storytelling and the automation infrastructure that scales it.
        </motion.h2>
        <motion.div variants={fadeUp} className="prose prose-lg max-w-none text-[#321A12]/75 space-y-6">
          <p>
            For too long, digital agencies have forced brands to choose: invest in creative content, or invest in technical infrastructure. The result is an industry full of beautiful work that underperforms, and powerful tech stacks that no one finds.
          </p>
          <p>
            Marcoir was built to end that compromise. We bring video strategy, web development, mobile applications, and AI automation under a single roof — not as separate service lines with separate P&Ls, but as an integrated capability set that compounds on itself.
          </p>
          <p>
            When your video campaign generates leads, your AI voice agent qualifies them overnight. When your web platform converts, your automation suite eliminates the manual work that follows. This is convergence in practice — and it is the only way we operate.
          </p>
        </motion.div>
      </motion.section>
      ...
      >
        ...
        <motion.div variants={fadeUp} className="space-y-6">
          <div className="glass-panel p-8 rounded-3xl">
            <div className="text-5xl font-serif font-bold text-[#FE5C57] mb-2">4.2M+</div>
            <p className="text-[#321A12]/70 font-medium">Organic views generated across client campaigns</p>
          </div>
          <div className="glass-panel p-8 rounded-3xl">
            <div className="text-5xl font-serif font-bold text-[#02E5D2] mb-2">5</div>
            <p className="text-[#321A12]/70 font-medium">International markets served: UK, USA, UAE, Australia, Pakistan</p>
          </div>
          <div className="glass-panel p-8 rounded-3xl">
            <div className="text-5xl font-serif font-bold text-[#321A12] mb-2">68%</div>
            <p className="text-[#321A12]/70 font-medium">Average reduction in manual call handling overhead via AI deployment</p>
          </div>
        </motion.div>
      </motion.section>
      ...
      >
        ...
        <motion.div variants={fadeUp}>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#FE5C57] text-white px-10 py-4 rounded-full text-lg font-medium hover:bg-[#FE5C57]/90 transition-all shadow-xl shadow-[#FE5C57]/20 hover:-translate-y-1"
