...
import { Video, Code2, Smartphone, Bot, ArrowRight, CheckCircle2 } from "lucide-react";
    ...
    <div className="flex flex-col gap-32">
      ...
      >
        ...
        <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl font-serif font-bold text-[#321A12] mb-6 leading-tight">
          Full-Stack <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FE5C57] to-[#02E5D2]">Digital Capabilities</span>
        </motion.h1>
        <motion.p variants={fadeUp} className="text-xl text-[#321A12]/70 max-w-2xl mx-auto">
          Four disciplines. One agency. Zero compromises. Built for brands that refuse to separate strategy from execution.
        </motion.p>
      </motion.section>
      ...
      >
        <motion.div variants={fadeUp}>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#321A12] text-white px-8 py-3.5 rounded-full font-medium hover:bg-[#321A12]/90 transition-all hover:-translate-y-0.5"
            data-testid="link-services-video-cta"
          >
      ...
      >
        ...
        <motion.div variants={fadeUp} className="order-1 lg:order-2">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#FE5C57] text-white px-8 py-3.5 rounded-full font-medium hover:bg-[#FE5C57]/90 transition-all hover:-translate-y-0.5 shadow-lg shadow-[#FE5C57]/20"
            data-testid="link-services-web-cta"
          >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeUp}>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 border-2 border-[#321A12] text-[#321A12] px-8 py-3.5 rounded-full font-medium hover:bg-[#321A12] hover:text-white transition-all"
              data-testid="link-services-mobile-cta"
            >
      ...
      >
        <motion.div variants={fadeUp}>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#FE5C57] to-[#02E5D2] text-white px-8 py-3.5 rounded-full font-medium hover:opacity-90 transition-all shadow-xl hover:-translate-y-0.5"
            data-testid="link-services-ai-cta"
          >
      ...
      {/* Bottom CTA */}
      <motion.section
        className="glass-panel rounded-[3rem] p-12 md:p-20 text-center"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={stagger}
      >
        <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-serif font-bold text-[#321A12] mb-6">
          One agency. All four capabilities.
        </motion.h2>
        <motion.p variants={fadeUp} className="text-lg text-[#321A12]/70 mb-10 max-w-2xl mx-auto">
          Most agencies pick one lane. Marcoir operates across all four — giving you a unified team that understands how each discipline amplifies the others.
        </motion.p>
        <motion.div variants={fadeUp}>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#FE5C57] text-white px-10 py-4 rounded-full text-lg font-medium hover:bg-[#FE5C57]/90 transition-all shadow-xl hover:-translate-y-1"
